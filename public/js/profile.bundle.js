...
/* harmony export */ });
/* unused harmony exports setCurrentUser, validateSession, getCurrentUser, getCurrentUserSync, logout, isLoggedIn, isLoggedInSync, initAuth, hideElement, showElement */
  ...
  try {
    ...
    if (logoutBtn) {
      ...
      logoutBtn.addEventListener("click", async () => {
        try {
          (0,_auth_js__WEBPACK_IMPORTED_MODULE_0__.showLoading)("logoutBtnProfile", "logoutSpinner");

          const { error } = await _supabase_client_js__WEBPACK_IMPORTED_MODULE_1__.supabase.auth.signOut();

          if (error) throw error;

          (0,_auth_js__WEBPACK_IMPORTED_MODULE_0__.showStatus)("Déconnexion réussie. Redirection...", "success");
          ...
          (0,_auth_js__WEBPACK_IMPORTED_MODULE_0__.showError)("Une erreur est survenue lors de la déconnexion.");
          (0,_auth_js__WEBPACK_IMPORTED_MODULE_0__.hideLoading)("logoutBtnProfile", "logoutSpinner");
        }
      });
    }
    ...
    (0,_auth_js__WEBPACK_IMPORTED_MODULE_0__.showError)("Une erreur est survenue lors du chargement du profil.");
